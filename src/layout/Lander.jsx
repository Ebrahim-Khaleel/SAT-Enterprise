function Lander() {
    return (
        <section 
            ...
            className="relative w-full h-[700px] bg-gradient-to-b from-[#101917] to-[#1B2A25]"
        >
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full relative">
                {/* Left Content */}
                <div className="max-w-2xl pt-[130px]">
                    <h1 className="text-[50px] font-medium font-inter text-[#E4FFDE] mb-8 leading-[65px]">
                        Streamlined <span className="text-white text-[50px] font-bold italic font-arsenal">FMCG</span>
                        <div 
                            className="h-[7px] w-[124px] rounded-full"
                            style={{
                    ...
                    <p className="text-[#E4FFDE]/65 text-lg mb-10">
                    ...
                    <a href="#contact" className="inline-block">
                        <button className="bg-[#C18820] text-white font-inter font-bold text-[16px] justify-center rounded-lg flex items-center w-[148px] h-[40px]">
                            Contact Us
